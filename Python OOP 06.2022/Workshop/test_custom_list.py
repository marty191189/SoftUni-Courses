...
from errors import NoElementsInTheListError, NoSuchValueError
...
class TestCustomIntList(TestCase):
    ...
    def test_add_first_adds_element_to_the_front(self):
        custom_list = CustomIntList()
        custom_list.append(10)
        custom_list.append(5)
        self.assertEqual([10, 5], custom_list._CustomIntList__values)

        custom_list.add_first(-3)

        self.assertEqual([-3, 10, 5], custom_list._CustomIntList__values)
    ...
    def test_dictionize_odd_count(self):
        ...
        custom_list.append(5)
        custom_list.append(15)
        self.assertEqual([10, 5, 15], custom_list._CustomIntList__values)
    ...
    def test_move_moves_n_values_in_the_end(self):
        custom_list = CustomIntList()
        custom_list.append(5)
        custom_list.append(10)
        custom_list.append(15)
        custom_list.append(20)
        self.assertEqual([5, 10, 15, 20], custom_list._CustomIntList__values)

        result = custom_list.move(2)

        self.assertEqual([15, 20, 5, 10], custom_list._CustomIntList__values)
    ...
    def test_overbound(self):
        ...
        custom_list.append(10)
        custom_list.append(15)
        self.assertEqual([5, 20, 10, 15], custom_list._CustomIntList__values)
    ...
    def test_underbound(self):
        ...
        custom_list.append(10)
        custom_list.append(15)
        self.assertEqual([20, 5, 10, 15], custom_list._CustomIntList__values)
