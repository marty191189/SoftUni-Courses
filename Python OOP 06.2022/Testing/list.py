...
class IntegerListTest(TestCase):
    ...
    def test_is_initialized_correctly_with_wrong_data(self):
        integer = IntegerList("Test", 5.6, 10.2)
        self.assertEqual([], integer._IntegerList__data)

    def test_is_initialized_correctly_with_integers_data(self):
        integer = IntegerList("Test", 5)
    ...
    def test_add_method_incorrect_data_raises(self):
        ...
        with self.assertRaises(ValueError) as exception:
            integer.add("5")
        self.assertEqual("Element is not Integer", str(exception.exception))
    ...
    def test_remove_invalid_index_raises(self):
        ...
        self.assertEqual("Index is out of range", str(exception.exception))
