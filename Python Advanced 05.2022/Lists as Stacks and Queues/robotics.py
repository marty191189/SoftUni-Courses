...
def read_robots():
    ...
    for el in robots_input:
        robot_details = el.split('-')
...
def to_str_time(time_in_seconds_1):
    hours = time_in_seconds_1 // 3600
    minutes = (time_in_seconds_1 % 3600) // 60
    seconds = (time_in_seconds_1 % 3600) % 60
...
time_in_seconds = convert_to_seconds(starting_time_parts[0], starting_time_parts[1], starting_time_parts[2])
